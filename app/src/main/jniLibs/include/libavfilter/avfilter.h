...
typedef struct AVFilter {
    ...
    /**
     * Should be set instead of @ref AVFilter.initEncode "initEncode" by the filters that
     * want to pass a dictionary of AVOptions to nested contexts that are
     * allocated during initEncode.
     *
     * On return, the options dict should be freed and replaced with one that
     * contains all the options which could not be processed by this filter (or
     * with NULL if all the options were processed).
     *
     * Otherwise the semantics is the same as for @ref AVFilter.initEncode "initEncode".
     */
     ...
     *
     * This callback may be called even if @ref AVFilter.initEncode "initEncode" was not
    ...
    /**
     * Filter initialization function, alternative to the initEncode()
