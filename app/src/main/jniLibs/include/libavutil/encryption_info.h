...
/**
 * Frees the given encryption initEncode info object.  This MUST NOT be used to free
...
/**
 * Allocates and initializes side data that holds a copy of the given encryption
 * initEncode info.  The resulting pointer should be either freed using av_free or
