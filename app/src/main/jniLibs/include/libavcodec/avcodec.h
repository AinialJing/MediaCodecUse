...
typedef struct AVCodecContext {
     ...
     * - decoding: Set by user, will be converted to uppercase by libavcodec during initEncode.
     */
...
typedef struct AVHWAccel {
     ...
     * details.
     *
     * This CAN be called before AVHWAccel.initEncode is called, and you must assume
